...
ZIP_NAME = "EversoloScreenControl.zip"
GITHUB_URL = "https://github.com/SimonArnold002/LMS-Eversolo-Screen-Control"
# The version badge is read live from install.xml; the rest are static.
STATIC_BADGES = ["LMS 8.0+", "DMP-A8 · DMP-A6", "Per-player"]


def read_version(root):
    """Current plugin version from install.xml (the single source of truth)."""
    try:
        with open(os.path.join(root, "EversoloScreenControl", "install.xml"), encoding="utf-8") as f:
...
<title>Eversolo Screen Control — LMS Plugin</title>
</head>
<body>
<p>Redirecting to <a href="README.html">the Eversolo Screen Control page</a>…</p>
</body>
</html>
"""
